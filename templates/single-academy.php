...
<div class="edu-single-wrapper" style="max-width: 1200px; margin: 2rem auto; padding: 0 1rem;">
    <article class="edu-single edu-single-academy" style="background: #fff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        
        <!-- هدر -->
        <div class="edu-single-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #fff; padding: 2rem;">
            <div class="edu-back-link" style="margin-bottom: 1rem;">
                <a href="<?php echo get_post_type_archive_link('academy'); ?>" style="color: #fff; text-decoration: none; opacity: 0.9;">← بازگشت به لیست</a>
            </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 350px; gap: 2rem; padding: 2rem;">
            ...
            <aside class="edu-sidebar">
                ...
                <div style="background: #f9fafb; padding: 1.5rem; border-radius: 12px; border: 2px solid #e5e7eb; margin-bottom: 1.5rem;">
                    ...
                    <p style="margin: 0; line-height: 1.8; color: #374151;"><?php echo nl2br(esc_html($address)); ?></p>
                </div>
                <?php endif; ?>
